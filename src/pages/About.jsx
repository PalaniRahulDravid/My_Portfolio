...
export default function About() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gray-900 text-white px-4 sm:px-10">
        ...
        >
          <div className="relative w-48 xs:w-56 sm:w-80 h-48 xs:h-56 sm:h-80 flex items-center justify-center">
            <motion.div
              ...
              className="absolute w-52 xs:w-64 sm:w-96 h-52 xs:h-64 sm:h-96 bg-yellow-400 rounded-full opacity-25 animate-pulse"
            ></motion.div>
            <motion.img
              src="/profile.png"
              alt="Rahul's Profile"
        ...
        >
          ...
          <div className="mb-6 mt-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-start">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="bg-yellow-400/20 text-yellow-300 px-3 py-1 rounded-full font-semibold text-xs xs:text-sm shadow hover:bg-yellow-400/40 transition"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="flex space-x-6 mt-4 justify-center md:justify-start">
            <a
              ...
              className="text-gray-300 hover:text-white text-2xl xs:text-3xl md:text-4xl transition duration-300"
              aria-label="GitHub"
            >
              <FaGithub />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-500 hover:text-blue-700 text-2xl xs:text-3xl md:text-4xl transition duration-300"
              aria-label="LinkedIn"
            >
              <FaLinkedin />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-400 hover:text-blue-600 text-2xl xs:text-3xl md:text-4xl transition duration-300"
              aria-label="Twitter"
            >
              <FaTwitter />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-yellow-400 hover:text-yellow-500 text-2xl xs:text-3xl md:text-4xl transition duration-300"
              aria-label="LeetCode"
            >
              <FaCode />
            </a>
